...
function agregarTexto(data, imprimir) {
    ...
    doc.setFontSize(13);
    /* Nombre */
    doc.text(25, 39, data.nombre);
    /* fecha */
    doc.text(164, 39, fechaact);
    /* edad */
    doc.text(95, 50, data.edad);
    /* peso */
    doc.text(127, 50, data.peso);
    /* tall */
    doc.text(162, 50, data.talla);
    /* temperatura */
    doc.text(198, 50, data.temp);
